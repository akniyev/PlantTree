...
open class ProjectsAPI: APIBase {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func apiProjectsByIdGet(id: Int32, completion: @escaping ((_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func apiProjectsByIdGetWithRequestBuilder(id: Int32) -> RequestBuilder<Void> {
